...
pcall(function()
   userinfo = HttpService:JSONDecode(readfile("MongCordum.txt"));
end)
...
local function SaveInfo()
   ...
   userinfo["user"] = user
   userinfo["tag"] = tag
   writefile("MongCordum.txt", HttpService:JSONEncode(userinfo));
end
...
function RadientPaid:Window(text,maincolor)
   ...
   UserImage.Image = "http://www.roblox.com/asset/?id=6226001157"
   ...
   UserTag.TextColor3 = Color3.fromRGB(13, 221, 236)
   UserTag.TextSize = 13.000
   UserTag.TextTransparency = 0
   UserTag.TextXAlignment = Enum.TextXAlignment.Left

   UserName.Text = "Kitaku Hub"
   UserTag.Text = "#" .. " Mong Cor dum"
   ...
   function RadientPaid:Notification(titletext, desctext, btntext)
      ...
      AlrightBtn.MouseEnter:Connect(function()
         TweenService:Create(
            AlrightBtn,
            TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
            {BackgroundColor3 = Color3.fromRGB(13, 221, 236)}
         ):Play()
      end)
   ...
   function ServerHold:Server(text,textgame, img)
      ...
      Server.TextColor3 = Color3.fromRGB(13, 221, 236)
      ...
      ServerTitle.TextColor3 = Color3.fromRGB(13, 221, 236)
      ...
      function ChannelHold:Channel(text)
         ...
         function ChannelContent:Toggle(text,default,callback)
            ...
            Toggle.MouseButton1Click:Connect(function()
               if toggled == false then
                  ...
                  TweenService:Create(ToggleFrame,TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = Color3.fromRGB(13, 221, 236)}):Play()
         ...
         function ChannelContent:Slider(text, min, max, start, callback)
            ...
            SliderTitle.BackgroundColor3 = Color3.fromRGB(13, 221, 236)
            ...
            CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(13, 221, 236)
         ...
         function ChannelContent:Dropdown(text, list, callback)
            ...
            DropItemHolder.ScrollBarImageColor3 = Color3.fromRGB(13, 221, 236)
